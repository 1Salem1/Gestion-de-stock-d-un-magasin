...
MenuPrincipal:
    ...
    case '2':
        ...
        break;
    case '0':
        printf("____________     BYE BYE     ___________\n");
        exit(0);
        break;
    }
MenuGestionStock:
...
GestionCategories:
    ...
    // optionnel mahich mawjouda fel enoncé
    printf("*  5- afficher les catégories                      *\n");
    printf("* >> Tapez votre Choix:                          * ");
    do
    {
    ...
    case '4':
        ...
        break;
    case '5':
        afficher_categorie(TabCat , &NbCat);
        break;
    case '0':
        printf("_____________        BYE BYE        _____________\n");
        exit(0);
        break;
    }
GestionTypes:
